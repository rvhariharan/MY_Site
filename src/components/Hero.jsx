        ...
        <section id="hariharan" className="min-h-[72vh] flex items-center">
            <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative group">
                    <div
                        className="rounded-2xl edge-acrylic border border-white/20 p-6 transition-all duration-700 ease-out group-hover:scale-[1.03] group-hover:border-edgeOrange/40 group-hover:shadow-[0_0_60px_rgba(255,106,0,0.25)] overflow-hidden relative"
                    >
                        <div className="flex items-center gap-4">

                            {/* Photo Card (Hover Image Change) */}
                            <div
                                className="w-36 h-36 rounded-xl overflow-hidden relative transition-all duration-700 ease-out"
                            >
                                {/* Default image */}
                                <img
                        ...
                        {/* soft glow circle */}
                        <div
                            className="pointer-events-none absolute -right-8 -bottom-8 w-44 h-44 rounded-full blur-3xl bg-edgeOrange/20 transition-all duration-700 group-hover:scale-[1.4] group-hover:bg-edgeOrange/30"
                        ></div>
                    </div>
                </div>
